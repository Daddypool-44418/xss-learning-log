...
| 08 | [Content Security Policy (CSP)](posts/08-content-security-policy.md) | Mitigating XSS with CSP, bypassing CSP, clickjacking protection | ✅ Published |
| 09 | [Preventing XSS](posts/09-preventing-xss.md) | Input filtering, output encoding, response headers, template engines, CSP as last line of defense | ✅ Published |
